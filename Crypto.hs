...
newtype SSign = SSign B.ByteString deriving Show
newtype PSign = PSign B.ByteString deriving Show
newtype PEnc = PEnc B.ByteString deriving Show
newtype SEnc = SEnc B.ByteString deriving Show
newtype Sig = Sig B.ByteString deriving Show
newtype Nonce = Nonce B.ByteString deriving Show
newtype Hash = Hash B.ByteString deriving Show
newtype SymmetricKey = SymmetricKey B.ByteString deriving Show
