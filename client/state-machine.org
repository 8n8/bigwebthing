...
|---------------------+--------------------------------------+---------------------------------------+--------------------------------|
| Arguments           | Don't care                           | mode: update crypto                   | Read static keys file          |
|---------------------+--------------------------------------+---------------------------------------+--------------------------------|
| New static keys     | Don't care                           | static keys: ...                      | + Write static keys            |
|                     |                                      |                                       | + Connect to server            |
|---------------------+--------------------------------------+---------------------------------------+--------------------------------|
| Static keys file    | if fileOk {                          | if fileOk {                           | if fileOk {                    |
|                     | mode: update crypto                  | static keys: ...                      | Connect to server              |
|                     | } else {                             | }                                     | } else {                       |
|                     | Don't care                           |                                       | Make static keys               |
|                     | }                                    |                                       | }                              |
|---------------------+--------------------------------------+---------------------------------------+--------------------------------|
| Server connection   | Don't care                           | status: making server sessions secret | Make session secret            |
|                     |                                      | conn: ...                             |                                |
|---------------------+--------------------------------------+---------------------------------------+--------------------------------|
...
|---------------------+--------------------------------------+---------------------------------------+--------------------------------|
| Written to server   | Don't care                           | unchanged                             | if error {                     |
|                     |                                      |                                       | print message and end          |
|                     |                                      |                                       | }                              |
|---------------------+--------------------------------------+---------------------------------------+--------------------------------|
| Written file        | Don't care                           | unchanged                             | if error {                     |
|                     |                                      |                                       | panic                          |
|                     |                                      |                                       | }                              |
|---------------------+--------------------------------------+---------------------------------------+--------------------------------|
